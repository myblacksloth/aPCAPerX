...
# Lightweight AI assistant settings. The backend sends only a compact subset of
# relevant packets to the external model service, never the full analysis.
...
AI_TIMEOUT_SECONDS = _float_env("PCAPCAPER_AI_TIMEOUT_SECONDS", 120.0, 2.0)
